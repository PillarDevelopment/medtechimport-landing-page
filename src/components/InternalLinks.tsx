        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                <span className="text-gray-700 hover:text-blue-600">одноразовые стоматологические инструменты</span>
              </Link>
              <Link 
                href="/catalog/retraction-cords" 
                className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <span className="text-gray-700 hover:text-blue-600">ретракционные нити</span>
              </Link>
              <Link 
                href="/catalog" 
                className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <span className="text-gray-700 hover:text-blue-600">каталог товаров</span>
              </Link>
              <Link 
                href="/about" 
                className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <span className="text-gray-700 hover:text-blue-600">о компании</span>
              </Link>
            </div>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <span className="text-gray-700 hover:text-blue-600">алмазный бор круглый 1.2мм</span>
              </Link>
              <Link 
                href="/product/tip-angled-1-1" 
                className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow"
              >
                <span className="text-gray-700 hover:text-blue-600">угловой наконечник 1:1</span>
              </Link>
              <Link 
              ...
              <Link 
                ...
                className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow"
              >
                <span className="text-gray-700 hover:text-blue-600">ретракционная нить гемостатическая 5м</span>
              </Link>
              <Link 
                href="/product/scalpel-blade-15c" 
                className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow"
              >
                <span className="text-gray-700 hover:text-blue-600">лезвие скальпеля 15C</span>
              </Link>
              <Link 
                href="/product/silicone-putty-heavy" 
                className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow"
              >
                <span className="text-gray-700 hover:text-blue-600">силиконовая слепочная масса</span>
              </Link>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-600">Угловые и прямые наконечники</p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-600">Полный набор инструментария</p>
            </div>
            <ArrowRight className="w-4 h-4 text-gray-400" />
          </Link>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-600">Алмазные и твердосплавные боры</p>
            </div>
            <ArrowRight className="w-4 h-4 text-gray-400" />
          </Link>
        </div>
