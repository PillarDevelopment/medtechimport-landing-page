        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6">
              Поставка{' '}
              <span className="text-primary-500">медицинского</span>{' '}
              оборудования
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Прямые поставки от ведущих производителей. Полный комплект документов, 
              гарантийное обслуживание и помощь в сертификации. Ваш надежный партнер 
              в оснащении медицинских учреждений.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Поставок</div>
              </div>
              <div className="text-center">
